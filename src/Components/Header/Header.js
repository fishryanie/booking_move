                ...
                <nav className="navbar navbar-expand-lg navbar-dark pt-0">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ml-auto border-bottom">
                            ...
                            <li className="nav-item px-3"><NavLink className="nav-link text-light nav-item" to="/app">APPS DOWNLOAD</NavLink></li>
                            <li className="nav-item px-3"><NavLink className="nav-link text-light nav-item" to="/about">ABOUT</NavLink></li>
                            <li className="nav-item px-3"><NavLink className="nav-link text-light nav-item" to="/event">EVENT</NavLink></li>
                            <li className="nav-item px-3"><NavLink className="nav-link text-light nav-item" to="/contact">CONTACT</NavLink></li>
                            <li className="nav-item px-3"><NavLink className="nav-link text-light nav-item" to="/register">SIGN UP</NavLink></li>
                            <li className="nav-item px-3 dropdown">
                                ...
                                </NavLink> : <NavLink className="nav-link text-light nav-item" to="/login">SIGN IN</NavLink>}
                                <ul className="dropdown-menu bg-transparent" aria-labelledby="navbarScrollingDropdown" style={{border:'none'}} >
                                    ...
                                    <li className="nav-item mb-2"><a className="nav-link dropdown-item text-white" href="#">INFO</a></li>
