...
const Hand = styled.g `transition: transform 0.03s;`
const Glasses = styled.g `transition: transform 0.15s;`
const Wink = styled.g `display: none;`
export default function UIchekout(props) {
  const { onMouse } = props
  return (
    <section className='col-4 mb-3 mx-auto iucheckout'>
      
     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 216.3 234.1" enableBackground="new 0 0 216.3 234.1" xmlSpace="preserve">
  <g id="shadow">
    <g>
  ...
  <Hand id="back_hand" style={{transform:onMouse.hand}}>
    <g>
  ...
  <Hand id="front_hand" style={{transform:onMouse.hand}}>
    <g>
      <g>
  ...
  <g id="coins">
    ...
    <g>
      ...
      <polygon opacity="0.24" clipPath="url(#SVGID_4_)" fill="#ED1C24" points="146.8,176.4 150.7,184.1 173.6,191.5 173.4,198.3 
  ...
  <g id="mouth" style={{transform:onMouse.mouth}}>
    <g>
  ...
  <Wink id="right_eye_wink" style={{display:onMouse.wink}}>
    <g display="inline">
  ...
  <g id="right_eye" style={{display:onMouse.eye}} ><g><path fill="#363284" d="M133.5,53.6c-0.6-0.3-1.2-0.6-1.8-0.9c0.1-0.5,0.2-0.9,0.2-1.4c0-4-3.2-7.3-7.3-7.3c-4,0-7.3,3.2-7.3,7.3c0,0.6,0.1,1.2,0.2,1.7c-0.8,0.4-1.4,0.8-1.9,1.1c-0.5,0.3-0.7,1-0.3,1.6c0.2,0.3,0.6,0.5,0.9,0.5c0.2,0,0.4-0.1,0.6-0.2c2.8-1.9,8.5-4.4,15.4-0.4c0.5,0.3,1.2,0.1,1.5-0.4C134.2,54.6,134,54,133.5,53.6z" /><g><path fill="#FFFFFF" d="M123,45.8c0.2,0.2,0.3,0.5,0.1,0.7s-0.4,0.2-0.6,0c-0.2-0.2-0.4-0.4-0.2-0.6S122.8,45.6,123,45.8z" /></g>
      <g>
  ...
  <Glasses className="sunglasses" style={{transform:onMouse.glasses}}>
    <g>
      <g>
