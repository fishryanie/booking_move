...
export default function CreditCard(props) {
  ...
  <div className="container_creditcard preload mx-auto">
    <div className={`creditcard ${infoCard.rotate}`}>
      <div className="front">
        <div id="ccsingle" dangerouslySetInnerHTML={{__html: infoCard.logo}}  />
        ...
        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style={{enableBackground: 'new 0 0 750 471'}} xmlSpace="preserve">
          <g id="Front">
            <g id="CardBackground">
              <g id="Page-1_1_">
                <g id="amex_1_">
                  <path id="Rectangle-1_1_" className={`lightcolor ${infoCard.color}`} d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40
                      C0,17.9,17.9,0,40,0z" />
                </g>
              </g>
              <path className={`darkcolor ${infoCard.color}dark`} d="M750,431V193.2c-217.6-57.5-556.4-13.5-750,24.9V431c0,22.1,17.9,40,40,40h670C732.1,471,750,453.1,750,431z" />
            </g>
            <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" className="st2 st3 st4 text-uppercase">{infoCard.cardNumber !== '' ? infoCard.cardNumber : '1234 5678 9123 1891'}</text>
            <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" className="st2 st5 st6">{infoCard.cardHolder !== '' ? infoCard.cardHolder : 'PHAN HONG QUAN'}</text>
            ...
            <g>
              <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" className="st2 st5 st9">{infoCard.expires !== '' ? infoCard.expires : '12/12'}</text>
            ...
            <g id="cchip">
              ...
              <g>
                ...
                <g><rect x="82.8" y="82.1" className="st12" width="25.8" height="1.5" /></g>
                <g><rect x="82.8" y="117.9" className="st12" width="26.1" height="1.5" /></g>
                <g>
      ...
      <div className="back">
        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style={{enableBackground: 'new 0 0 750 471'}} xmlSpace="preserve">
          ...
          <g id="Back">
            <g id="Page-1_2_">
              <g id="amex_2_">
                <path id="Rectangle-1_2_" className={`darkcolor ${infoCard.color}dark`} d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40
                  C0,17.9,17.9,0,40,0z" />
              </g>
            </g>
            ...
            <text className ="text-uppercase" transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" className="st12 st13">{infoCard.cardHolder}</text>
          </g>
        </svg>
      </div>
    </div>
