...
import imgInfo01 from "../../Assets/Images/ImageContact/contact_info_01.png";
import imgInfo02 from "../../Assets/Images/ImageContact/contact_info_02.png";
            ...
            <div className="container">
              <div className="row justify-content-between">
                ...
                <div className="col-md-5 col-lg-6 contact_info pl-0">
                  <div
                    className="row "
                    style={{ padding: "50px 20px", background: "#001232" }}
                  >
                    <div
                      className="d-flex col-sm-6 col-md-12 col-xl-6 p-0"
                      style={{
                        borderRight: "2px solid rgba(255, 255, 255, 0.2)",
                      }}
                    >
                      <div className="col-3">
                        <img src={imgInfo01} alt="" />
                      </div>
                      <div className="col-9">
                        <h6>PHONE NUMBER</h6>
                    ...
                    <div className="d-flex col-sm-6 col-md-12 col-xl-6 p-0">
                      <div className="col-3">
                        <img src={imgInfo02} alt="" />
                      </div>
                      <div className="col-9">
                        <h6>Email</h6>
                        <a className="text-success" href="">
                          flex_cinema@gmail.com
                        </a>
                      </div>
                    </div>
                  </div>
