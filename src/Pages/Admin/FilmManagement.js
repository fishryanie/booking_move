        ...
        <div class="row">
          <div class="col-8">
            ...
            >
              Thêm phim
              <i
                class="bx bx-cloud-upload bx-fade-up mx-2"
                style={{ fontSize: "20px" }}
              ></i>
            </button>
          </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    <input
                      type="number"
                      className="form-control"
                      placeholder="Thêm lượt đánh giá"
                    />
                  </div>
                  <div className="col-md-6 mb-3">
